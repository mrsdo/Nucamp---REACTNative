...
const AboutScreen = () => {
    ...
    // In the if block for partners.errMess inside the ScrollView wrap the Mission and Card tags with an Animatable.View with the following props:
    // animation equal to the string 'fadeInDown'.
